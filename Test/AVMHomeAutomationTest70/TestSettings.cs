namespace AVMHomeAutomationTest70
{
    public static class TestSettings
    {
        ...
        public static TestDevice DeviceDect500Light = new()     { Ain = "13077 0294352-1", Name = "Light",            Product = "FRITZ!DECT 500",             Manufacturer = "AVM", FirmwareVersion = "34.10.16.16.015" };
